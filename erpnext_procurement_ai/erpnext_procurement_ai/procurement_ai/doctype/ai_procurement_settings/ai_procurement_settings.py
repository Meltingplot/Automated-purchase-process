...
class AIProcurementSettings(Document):
    ...
    def get_settings_dict(self):
        ...
        return {
            ...
            "claude_api_key": self.get_password("claude_api_key"),
            "openai_api_key": self.get_password("openai_api_key"),
            "gemini_api_key": self.get_password("gemini_api_key"),
            ...
            "local_llm_api_key": self.get_password("local_llm_api_key"),
